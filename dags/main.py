...
with DAG(
    ...
    #"TriggerDagRunOperator" that allows you to trigger the execution of another DAG from within a running DAG.
    #It is useful when you want to create dependencies between multiple DAGs, where the completion of one DAG can trigger the start of another.
